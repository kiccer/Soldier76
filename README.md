...
1. 微调 `userInfo.sensitivity.Aim` 、 `userInfo.sensitivity.scopeX2` 、 `userInfo.sensitivity.scopeX3` 、 `userInfo.sensitivity.scopeX4` 、 `userInfo.sensitivity.scopeX6` 的值，使腰射、二倍、三倍、四倍、六倍压枪时弹印集中于一处。不需要倍镜压枪功能的可以跳过此步。
